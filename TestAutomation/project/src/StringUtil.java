...
public class StringUtil
{
    ...
    //Site of fault injections|||||||||||||||

    public static String trimToNullLower(String value)
    {
        if (value == null) return null;

        //first fault injection for this method comment out value = value.trim();
        value = value.trim();


        if (value.length() == 0) return null;

	//Second fault injection for this method return only value not value.tolowerCase();
	//return value;
    ...
    // Location of more fault injections///////////////////////////////////////////
    ...
    //First Fault injection for this method set return to true.
    ...
    for (Iterator i = stringCollection.iterator(); i.hasNext();)
	    ...
	    //Second Fault Injection for this method.  Set Return to false.
	    if (value.equals((String) o)) return true;
            //if (value.equals((String) o)) return false;
        }
	//Third Fault Injection for this method set return to true
	//return true;
        return false;
    }
